document.addEventListener("DOMContentLoaded", function () {
    ...
    setTimeout(function () {
     ...
     floatingImageContainer.addEventListener("click", function () {
        var relativeLink = "https://334234.github.io/entries/entry1/final/nose%202.html";
 ...
 bottomRightImageContainer.addEventListener("click", function () {
        var relativeLink = "https://334234.github.io/entries/entry3/final/index.html";
        var absoluteLink = new URL(relativeLink, window.location.href).href;
        window.open(absoluteLink, "_blank");
    });
topLeftImageContainer.addEventListener("click", function () {
        var relativeLink = "https://334234.github.io/entries/entry4/final/index.html";
        var absoluteLink = new URL(relativeLink, window.location.href).href;
        window.open(absoluteLink, "_blank");
    });
topCenterImageContainer.addEventListener("click", function () {
        var relativeLink = "https://334234.github.io/entries/entry5/index.html";
        var absoluteLink = new URL(relativeLink, window.location.href).href;
        window.open(absoluteLink, "_blank");
    });
topRightImageContainer.addEventListener("click", function () {
        var relativeLink = "https://334234.github.io/entries/entry6/final/index.html";
        var absoluteLink = new URL(relativeLink, window.location.href).href;
        window.open(absoluteLink, "_blank");
    });
